...
@RestClientTest(PrestClient.class)
@TestPropertySource(properties = {
        "prest.url=http://localhost:8080/api/stub/prest",
        "prest.username=testuser",
        "prest.password=testpass"
})
class PrestClientTest {

    @Autowired
    private PrestClient client;
    ...
    void transmitInvoice_ShouldAddBasicAuthHeader() {
        ...
        String expectedUrl = prestUrl + "/invoices";
