...
import org.example.anpfacturationbackend.mapper.TarifOTDPMapper;
...
import org.example.anpfacturationbackend.service.TarifOTDPService;
...
public class TarifOTDPServiceImpl implements TarifOTDPService {
    ...
    public TarifOTDPDTO update(@org.springframework.lang.NonNull Long id, TarifOTDPDTO dto) {
        ...
        if (dto.getPrestationId() != null) {
            ...
            org.example.anpfacturationbackend.entity.Prestation p = prestationRepository
