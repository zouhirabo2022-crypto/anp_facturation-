...
import org.anpfacturationbackend.entity.LigneBulletin;
...
public class BulletinService {
    ...
    /**
     * Importe un bulletin mÃ©tier et le sauvegarde avec le statut EN_ATTENTE.
     */
    public BulletinDTO createBulletin(BulletinDTO dto) {
        ...
        if (dto.getIdBulletinMetier() != null && bulletinRepository.findByIdBulletinMetier(dto.getIdBulletinMetier()).isPresent()) {
             throw new IllegalArgumentException("Bulletin avec ID mÃ©tier " + dto.getIdBulletinMetier() + " existe dÃ©jÃ .");
        }
        ...
        auditService.log("IMPORT_BULLETIN", "Bulletin importÃ©: " + saved.getIdBulletinMetier());
    ...
    public FactureDTO processBulletin(Long id) {
        ...
        auditService.log("PROCESS_BULLETIN", "Bulletin " + bulletin.getIdBulletinMetier() + " transformÃ© en facture " + createdFacture.getNumero());
