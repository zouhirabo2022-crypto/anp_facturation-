package org.anpfacturationbackend.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleDataIntegrity(DataIntegrityViolationException ex) {
        ...
        return buildErrorResponse(HttpStatus.CONFLICT, "Data Integrity Violation",
                "Suppression impossible: l'̩l̩ment est r̩f̩renc̩ par d'autres donn̩es.");
    }
    ...
    public ResponseEntity<Map<String, Object>> handleAccessDenied(AccessDeniedException ex) {
        return buildErrorResponse(HttpStatus.FORBIDDEN, "Access Denied",
                "Acc̬s refus̩: droits insuffisants pour cette op̩ration.");
    }
