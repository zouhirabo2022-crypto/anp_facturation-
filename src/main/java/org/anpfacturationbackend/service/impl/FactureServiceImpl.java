...
import org.anpfacturationbackend.entity.*;
import org.anpfacturationbackend.enums.StatutFacture;
import org.anpfacturationbackend.exception.ResourceNotFoundException;
import org.anpfacturationbackend.mapper.FactureMapper;
import org.anpfacturationbackend.repository.*;
import org.anpfacturationbackend.service.FactureService;
import org.anpfacturationbackend.service.AuditService;
import org.anpfacturationbackend.service.ExternalIntegrationService;
import org.anpfacturationbackend.service.FiscalRateService;
import org.anpfacturationbackend.service.PdfService;
...
public class FactureServiceImpl implements FactureService {
    ...
    private final org.anpfacturationbackend.service.EmailService emailService;
    ...
    public FactureServiceImpl(FactureRepository factureRepository,
            ...
            org.anpfacturationbackend.service.EmailService emailService,
    ...
    public FactureDTO create(FactureDTO dto) {
        ...
        for (LigneFactureDTO lineDto : dto.getLignes()) {
            ...
            boolean shouldCalculatePrice = (unitPrice == null || unitPrice == 0.0);

            // 1. Try to find OTDP Tariff
            if (shouldCalculatePrice && lineDto.getTypeTerrain() != null) {
            ...
            if (shouldCalculatePrice && lineDto.getCodePort() != null) {
            ...
            if (shouldCalculatePrice && lineDto.getPrestationId() != null) {
            ...
            // Set criteria fields on the entity
            ligne.setTypeTerrain(lineDto.getTypeTerrain());
            ligne.setNatureActivite(lineDto.getNatureActivite());
            ligne.setCategorie(lineDto.getCategorie());
            ligne.setCodePort(lineDto.getCodePort());
            ligne.setCodeActivite(lineDto.getCodeActivite());
    ...
    public void delete(@org.springframework.lang.NonNull Long id) {
        ...
        // throw new IllegalStateException("Impossible de supprimer une facture validÃ©e
        // ou payÃ©e.");
        // }
    ...
    private void sendInvoiceEmail(Facture facture) {
        try {
            ...
            String body = "Bonjour,\n\nVeuillez trouver ci-joint votre facture nÂ°" + facture.getNumero()
                    + ".\n\nCordialement,\nANP Facturation";
    ...
    public FactureDTO createAvoir(@org.springframework.lang.NonNull Long id) {
        ...
        for (LigneFacture originalLine : original.getLignes()) {
            ...
            // Copy criteria fields
            newLine.setTypeTerrain(originalLine.getTypeTerrain());
            newLine.setNatureActivite(originalLine.getNatureActivite());
            newLine.setCategorie(originalLine.getCategorie());
            newLine.setCodePort(originalLine.getCodePort());
            newLine.setCodeActivite(originalLine.getCodeActivite());
    ...
    @Override
    @Transactional(readOnly = true)
    public org.anpfacturationbackend.dto.DashboardStatsDTO getDashboardStats() {
        org.anpfacturationbackend.dto.DashboardStatsDTO stats = new org.anpfacturationbackend.dto.DashboardStatsDTO();
