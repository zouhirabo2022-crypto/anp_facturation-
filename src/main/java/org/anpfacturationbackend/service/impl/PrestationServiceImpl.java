...
import org.anpfacturationbackend.mapper.PrestationMapper;
import org.anpfacturationbackend.repository.PrestationRepository;
import org.anpfacturationbackend.repository.LigneFactureRepository;
...
import org.anpfacturationbackend.service.PrestationService;
    ...
    public PrestationDTO update(@org.springframework.lang.NonNull Long id, PrestationDTO dto) {
        ...
        if (dto.getCode() != null && !dto.getCode().equals(p.getCode())) {
            if (repository.existsByCode(dto.getCode())) {
                throw new IllegalArgumentException("Code prestation existe dÃ©jÃ ");
            }
    ...
    public void delete(@org.springframework.lang.NonNull Long id) {
        ...
        if (ligneFactureRepository.existsByPrestationId(id)) {
            throw new DataIntegrityViolationException(
                    "Suppression impossible: la prestation est utilisÃ©e dans des factures.");
        }
