...
public class TarifOTDPDTO {
    ...
    @NotBlank(message = "La nature d'activit̩ est obligatoire")
    private String natureActivite;

    @NotBlank(message = "La cat̩gorie (p̻che/autre) est obligatoire")
    private String categorie;

    @NotBlank(message = "L'unit̩ de base est obligatoire")
